                ...
                try {
                    ...
                    if (empty($this->reason)) {
                        if ($this->debugMode) {
                            ...
                            $this->details[] = 'Timestamp req: ' . $request->get_parameter('oauth_timestamp');
                            $this->details[] = 'Req signature: ' . $request->get_parameter('oauth_signature');
                            ...
                            $this->details[] = "Signature: {$signature}";
                            $this->details[] = "Base string: {$request->base_string}";
                            $this->reason = 'OAuth signature check failed - perhaps an incorrect secret or timestamp. - message: ' . $e->getMessage();
