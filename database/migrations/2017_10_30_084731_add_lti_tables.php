...
class AddLtiTables extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::statement('CREATE TABLE lti2_consumer (
        ...
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC'); //Needs long index

        DB::statement('ALTER TABLE lti2_consumer
  ADD UNIQUE INDEX lti2_consumer_consumer_key_UNIQUE (consumer_key256 ASC)');

        DB::statement('CREATE TABLE lti2_tool_proxy (
        ...
        DB::statement('ALTER TABLE lti2_tool_proxy
  ...
  ADD UNIQUE INDEX lti2_tool_proxy_tool_proxy_id_UNIQUE (tool_proxy_id ASC)');
        ...
        DB::statement('CREATE TABLE lti2_nonce (
          consumer_pk int(11) NOT NULL,
        ...
        DB::statement('ALTER TABLE lti2_nonce
  ADD CONSTRAINT lti2_nonce_lti2_consumer_FK1 FOREIGN KEY (consumer_pk)
  REFERENCES lti2_consumer (consumer_pk)');

        DB::statement('CREATE TABLE lti2_context (
        ...
        DB::statement('ALTER TABLE lti2_context
  ...
  ADD INDEX lti2_context_consumer_id_IDX (consumer_pk ASC)');
        ...
        DB::statement('CREATE TABLE lti2_resource_link (
        ...
        DB::statement('ALTER TABLE lti2_resource_link
  ...
  ADD INDEX lti2_resource_link_context_pk_IDX (context_pk ASC)');
        ...
        DB::statement('CREATE TABLE lti2_user_result (
        ...
        DB::statement('ALTER TABLE lti2_user_result
  ...
  ADD INDEX lti2_user_result_resource_link_pk_IDX (resource_link_pk ASC)');
        ...
        DB::statement('CREATE TABLE lti2_share_key (
        ...
        DB::statement('ALTER TABLE lti2_share_key
  ...
  ADD INDEX lti2_share_key_resource_link_pk_IDX (resource_link_pk ASC)');
    ...
    public function down()
    {
        ...
        DB::statement('DROP TABLE lti2_consumer');
        DB::statement('DROP TABLE lti2_context');
        DB::statement('DROP TABLE lti2_nonce');
        DB::statement('DROP TABLE lti2_share_key');
        DB::statement('DROP TABLE lti2_resource_link');
        DB::statement('DROP TABLE lti2_tool_proxy');
        DB::statement('DROP TABLE lti2_user_result');
